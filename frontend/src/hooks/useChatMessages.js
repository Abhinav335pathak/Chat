...
// export const fetchChatMessages = async (chatId, after) => {
//   const res = await getMessages(chatId, after);
...
//     const load = async () => {
//       try {
//         const decrypted = await fetchChatMessages(activeConversationId);
//         setMessages(decrypted);
//       } catch (err) {
//         console.error("Failed to load messages:", err);
//       }
